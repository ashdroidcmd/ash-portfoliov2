        ...
        <>
            <footer data-aos="fade-up" data-aos-once="true" className="footer-center flex flex-col justify-between items-center text-lg p-4 pb-10">
                ...
                <ul className="flex flex-row">
                    ...
                    {/* Linkedin */}
                    <li className="mx-4"><a href="https://www.linkedin.com/in/ash-gesite-25a28334b/" target="_blank" className="mx-3 rounded-3xl" title="Linkedin">
                    ...
                    {/* Github */}
                    <li className="mx-4"><a href="https://github.com/ashdroidcmd" target="_blank" className="mx-3 rounded-3xl" title="Github">
                        <svg className="text-white w-8 h-8 duration-500 ease-in-out transition hover:scale-150"
                    ...
                    <li className="mx-4"><a
                        ...
                        className="mx-3 rounded-3xl" title="Gmail">
                        <svg className="text-white w-8 h-8 duration-500 ease-in-out transition hover:scale-150"
